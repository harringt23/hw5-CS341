...
var host = "35.227.187.246"; //from GCloud instance (change to match your db)
var database = "CHEESECAKE"; //database name
var user = "root"; //username (change to match your db)
var password = "cheese-password"; //password (change to match your db, yes this is very poor practice)
